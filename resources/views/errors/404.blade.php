        ...
        <main class="main page-404 h-100">
            <div class="page-content d-flex align-items-center" style="height: 100vh;">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-8 col-lg-10 col-md-12 m-auto text-center">
                            <p class="mb-20"><img src="{{ asset('frontend/assets/imgs/page/page-404.png') }}"
                                    alt="" class="hover-up" /></p>
                            <h1 class="display-2 mb-30" style="color: black">Page Not Found</h1>
                            <p class="font-lg text-grey-700 mb-30">
                                The link you clicked may be broken or the page may have been removed.<br />
                                visit the <a href="{{ route('home') }}"> <span> Homepage</span></a> or <a
                                    href="#"><span>Contact us</span></a> about the problem
                            </p>
                            <a href="{{ route('home') }}"
                                style="
                                    ...
                                    font-weight: bold;
                                ">
                                <i class="fi-rs-home" style="margin-right:5px;"></i>
                                Back To Home Page
                            </a>
                        </div>
                    </div>
