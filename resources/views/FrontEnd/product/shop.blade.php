...
@endsection
@section('content')
{{-- Modern CSS from category_view.blade.php --}}
<style>
    /* --- Filter Sidebar Styles (copied from category_view.blade.php) --- */
    .prf-filter-modern {
        background: #fff;
    ...
    #prf-slider {
        height: 7px;
        background: linear-gradient(90deg, #e5e5e5 0%, #FF914D 50%, #e5e5e5 100%);
        border-radius: 7px;
        margin-top: 12px;
        border: none;
    }

    #prf-slider .ui-slider-range {
        background: linear-gradient(90deg, #FF914D 0%, #e07b39 100%);
        height: 7px;
        border-radius: 7px;
    }

    #prf-slider .ui-slider-handle {
        background: #fff;
    ...
    #prf-slider .ui-slider-handle:hover,
    #prf-slider .ui-slider-handle:focus {
        transform: scale(1.2);
        box-shadow: 0 3px 8px rgba(255, 145, 77, 0.3);
    }
    ...
    .prf-filter-btn:hover:not(:disabled) {
        background: linear-gradient(90deg, #e07b39 0%, #FF914D 100%);
    ...
    /* --- Modern Product Card Styles (copied from category_view.blade.php) --- */
    .modern-product-card {
    ...
    /* Responsive Design (copy all responsive blocks from category_view.blade.php) */
    ...
    <div class="container ">
        <div class="row justify-content-center">
            <div class="col-lg-10 text-md-center mt-1 mt-md-0">
                ...
                <h5 class="display-6 fw-semibold" style="color:black;">
                    {{ session()->get('language') == 'bangla' ? 'ডিল প্রতিদিন আপডেট করা হয়' : 'Get Our Best Products' }}
                </h5>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-3 col-sm-12">
            <!-- Modern Filter Sidebar (copied from category_view.blade.php) -->
