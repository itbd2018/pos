...
<head>
    ...
    <style>
        ...
        *,
        ...
        .tm_accent_bg_10 {
            background-color: rgba(255, 239, 93, 0.253);
        }
        ...
        .tm_accent_border_10 {
            border-color: rgba(255, 239, 93, 0.253);
        }
        ...
        .tm_invoice.tm_style1.tm_type1 .tm_shape_bg img {
            ...
            -o-object-fit: cover;
            object-fit: cover;
            -webkit-transform: skewX(-0deg) translateX(-45px);
            transform: skewX(-0deg) translateX(-45px);
        }
        ...
        .tm_invoice.tm_style1.tm_type1 .tm_invoice_seperator img {
            ...
            -webkit-transform: skewX(-0deg);
            transform: skewX(-0deg);
            -webkit-transform: skewX(-0deg) translateX(-10px);
        ...
        @media print {
            ...
            .tm_accent_bg_10 {
                background-color: rgba(255, 239, 93, 0.253) !important;
                -webkit-print-color-adjust: exact;
            }
...
<body style="background-color: white" style="border: 0px solid white !important; ">
    <div class="tm_invoice tm_style2 tm_type1 tm_accent_border tm_radius_0 " id="tm_download_section" style="border-top: 2px solid #FF914D; ">
        <div class="tm_invoice_in" style=" border-top:none !important;">
            <table style="width: 600px" style="border-top: 0px solid black !important; ">
                <tr >
                    <td width="400px">
                        <div class="tm_logo" style="left: -16px; top:5px">
                            ...
                            @endphp
                            @if ($logo != null)
                                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(base_path('public/' . $logo))) }} "
                                    style="max-width: 220px !important;" alt="{{ env('APP_NAME') }}">
                    ...
                    <td width="400px">
                        <p class="tm_mb0">
                            <b class="tm_primary_color" style="margin-bottom: 10px !important">Invoice No: </b>{{ $order->invoice_no }} <br>
                            <b class="tm_primary_color" style="margin-bottom: 10px !important">Invoice Date:
                            </b>{{ date('d-m-Y', strtotime($order->created_at)) }} <br>
                            <b class="tm_primary_color" style="margin-bottom: ">Website:
                            </b><a href="https://laptopache.com">https://laptopache.com</a>
                        </p>
                    ...
                    <td width="120px">
                        ...
                        <div class="tm_shape_bg tm_accent_bg_10 tm_border tm_accent_border_20"
            ...
            {{-- <td>
                    <div class="tm_border tm_accent_border_20 tm_radius_0 tm_accent_bg_10 tm_curve_35 tm_text_center" style="transform: skewX(-0deg); margin-left: 12px">
            ...
            <h2 class="tm_f16 tm_section_heading tm_heading_border tm_accent_border_20 tm_mb0"
                style="transform: skewX(-0deg); margin-left: 12px; margin-left: 0px; border-bottom: 0px; width:96.7%; margin-top:40px;">
                <span
                    class="tm_accent_bg_10 tm_radius_0 tm_curve_35 tm_border tm_accent_border_20 tm_border_bottom_0 tm_accent_color"
                    style=" width:100%; "><span style="transform: skewX(0deg)">Invoice
                        To</span></span></h2>

            <div class="tm_table tm_style1 tm_mb30" style="border-top: 0px solid white !important; ">
                <div class="tm_border  tm_accent_border_20 tm_border_top"
                    style="border-top: 0px solid white !important; ">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th class="tm_width_2 tm_semi_bold tm_accent_color tm_accent_bg_10 tm_text_right">
                                        Total</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @foreach ($order->order_details as $order_detail)
                                    <tr>
                                        ...
                                        <td class="tm_width_5 tm_accent_border_20">
                                            {{ $order_detail->product->name_en ?? ' ' }}<br>
                                            <small>
                                                @if ($order_detail->is_varient && count(json_decode($order_detail->variation)) > 0)
                                                    ...
                                                    @foreach (json_decode($order_detail->variation) as $varient)
                                                        <span>{{ $varient->attribute_name }} : <span
                                        ...
                                        <td class="tm_width_2 tm_accent_border_20 tm_text_right">
                                            {{ $order_detail->price * $order_detail->qty ?? ' ' }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    <tr>
        ...
        <td colspan="3" class="payment-info">
            ...
            <p class="tm_m0">Payment Status: 
                            ...
                            {{-- <hr> --}}
                            @if($order->order_type == 3)
                                <p class="tm_m0"><b class="tm_primary_color">Order type:</b> Installment</p>
                            @endif

                            @if($order->order_type == 1)
                                <p class="tm_m0"><b class="tm_primary_color">Order type:</b> Onsite</p>
                            @endif
        ...
        <td colspan="2" class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_medium">
            {{ $order->sub_total }} TK
        </td>
    ...
    @if ($order->order_type == 3)
        <tr>
            <td colspan="3" class="tm_border_none"></td> <!-- Empty cell for alignment -->
            <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">Addon (5% for Installment)</td>
            <td colspan="2" class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0">
                +{{ number_format(($order_detail->price * $order_detail->qty) * 0.05, 2) }} TK
            </td>
        </tr>
    @endif
    ...
    <tr>
        <td colspan="3" class="tm_border_none"></td> <!-- Empty cell for alignment -->
        <td class="tm_width_3 tm_bold tm_f16 tm_accent_color tm_accent_bg_10">Grand Total</td>
        
        <td colspan="2" class="tm_width_3 tm_bold tm_f16 tm_accent_color tm_text_right tm_accent_bg_10">
        @if($order->order_type == 3)
            {{ $order->sub_total  + $order->sub_total*0.05 - $order->coupon + $order->shipping_charge ?? ' ' }} TK
        @else
            {{ $order->sub_total - $order->coupon + $order->shipping_charge ?? ' ' }} TK
        @endif
        </td>
    </tr>
    </tr>
        ...
        <table width="600px">
            ...
            <tr style="padding-top: 100px">
                <td colspan="4" style="margin-right: 80px !important;">
                    <p class="tm_m0 tm_f18 tm_accent_color tm_mb5" style="margin-right: 150px !important;">Thank you for
                        your order</p>
                ...
                <td align="right" style="padding-left: 100px">
                    ...
                    @endphp
                    @if ($logo != null)
                        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(base_path('public/' . get_setting('site_logo')->value))) }} "
                            alt="{{ env('APP_NAME') }}" height="100px" width="200x">
                    @else
