    ...
    <div class="tm_container">
        ...
        <div class="row">
            <div class="col-md-6 col-6">
                <a style="color: green; font-weight: 900; font-size: 16px; margin-bottom: 10px"
                    href="{{ route('home') }}"> Back to
                    Home</a>
            </div>
            <div class="col-md-6 col-6" style="text-align: right">
                <a style="color: green; font-weight: 900; font-size: 16px; text-align: right"
                    href="{{ route('dashboard') }}">Back to
                    Dashboard</a>
            </div>
        </div>

        <div class="tm_invoice_wrap" style="" id="downloadinvoice">
                ...
                <div class="tm_invoice_in">
                    <div class="tm_invoice_head tm_mb20 tm_m0_md">
                        <div class="tm_invoice_left">
                            <div class="tm_logo">
                                ...
                                @endphp
                                @if ($logo != null)
                                    <img src="{{ asset($logo ?? 'null') }}" style="max-width: 220px !important;"
                                        alt="{{ env('APP_NAME') }}">
                                @else
                        ...
                        <div class="tm_invoice_right" style="">
                            <p class="tm_mb0">
                                <b class="tm_primary_color">Invoice No : </b>{{ $order->invoice_no }}<br>
                                <b class="tm_primary_color">Invoice Date :
                                </b>{{ \Carbon\Carbon::parse($order->date)->isoFormat('MMM Do YYYY') }} <br>
                                <b class="tm_primary_color">Website : </b><a href="https://laptopache.com">https://laptopache.com</a>
                            </p>

                            {{-- <p style="margin-bottom:5px; color:rgb(61, 61, 61)"> Name : {{ $order->name ?? '' }}</p>
                                <p style="margin-bottom:5px; color:rgb(61, 61, 61)"> Phone : {{ $order->phone ?? '' }}</p>
                                <p style="margin-bottom:5px; color:rgb(61, 61, 61)"> Address : {{ $order->address ?? '' }} sdfsdf sfdf sdfd sfdf sfdf  </p> --}}
                    ...
                    {{-- <div class="tm_invoice_info tm_mb30 tm_align_center"> --}}
                        {{-- <div class="tm_invoice_info_left tm_mb20_md">
                            <p class="tm_mb0">
                                <b class="tm_primary_color">Invoice No: </b>{{ $order->invoice_no }}<br>
                                <b class="tm_primary_color">Invoice Date:
                                </b>{{ \Carbon\Carbon::parse($order->date)->isoFormat('MMM Do YYYY') }}
                            </p>
                        </div> --}}
                        {{-- <div class="tm_invoice_info_right">
                            <div
                                ...
                                <div>
                                    <b class="tm_accent_color tm_f30 tm_bold tm_body_lineheight">
                                        {{ get_setting('business_name')->value ?? '' }}</b>
                                </div>
                            </div>
                        </div> --}}
                    {{-- </div> --}}
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tm_width_6 tm_border_left tm_accent_border_20">
                                                <b class="tm_primary_color tm_medium">Address:
                                                </b>{{ $order->address ?? '' }}
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="tm_width_5 tm_semi_bold tm_accent_color tm_accent_bg_10">Item
                                            </th>
                                            <th class="tm_width_3 tm_semi_bold tm_accent_color tm_accent_bg_10">Price
                                            </th>
                                            <th class="tm_width_1 tm_semi_bold tm_accent_color tm_accent_bg_10">Quantity
                                            </th>
                                            <th
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($order->order_details as $key => $order_detail)
                                            <tr>
                                                ...
                                                <td class="tm_width_1 tm_accent_border_20" style="text-align: center">
                                                    {{ $order_detail->qty ?? '' }}</td>
                                                </td>
                                                <td class="tm_width_2 tm_accent_border_20 tm_text_right">
                                                    {{ $order_detail->price * $order_detail->qty ?? ' ' }} TK</td>
                        ...
                        <div class="tm_left_footer">
                            ...
                            <div class="tm_right_footer">
                                ...
                                @if ($order->delivery_status == 'pending')
                                    <div class="d-none"
                                        style="display: flex; float: right; justify-content: space-between; padding: 8px 0px;">
                                        <div class="">
                                            <form action="{{ route('order.cancel.submit') }}" method="post"
                                                id="cancelOrderForm">
                                                @csrf
                                            ...
                                            <a style="color: red; font-weight: 600; font-size: 16px;" href="#"
                                                onclick="event.preventDefault(); $('#cancelOrderForm').submit()"><i
                                                    class="fa-solid fa-backward"></i> Cancel Order</a> <br>
                                        </div>
                    ...
                    <div class="tm_bottom_invoice tm_accent_border_20">
                        <div class="tm_bottom_invoice_left">
                            <p class="tm_m0 tm_f18 tm_accent_color tm_mb5" style="margin-bottom: 0;">Thank you for your Shopping.</p>
                        </div>
                        <div class="tm_bottom_invoice_right tm_mobile_hide">
                            <div class="tm_logo">
                                ...
                                @endphp
                                @if ($logo != null)
                                    <img src="{{ asset($logo ?? 'null') }}" style="max-width: 200px !important;"
                                        alt="{{ env('APP_NAME') }}">
                                @else
                                    <img src="{{ asset('upload/no_image.jpg') }}" alt="{{ env('APP_NAME') }}"
            ...
            <div class="tm_invoice_btns tm_hide_print" style="margin-bottom: 10px">
              ...
              <span class="tm_btn_text">Print</span>
                ...
                <a href="{{ route('order.download', $order->invoice_no) }}" id=""
                    class="tm_invoice_btn tm_color3" style="margin-bottom: 5px;">
