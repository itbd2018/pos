				        ...
				        <div class="card-body">
	                    	...
	                    	<div class="row">
				        		...
				        		<div class="col-sm-12 mb-3">
		                           <label for="marquee" class="col-form-label" style="font-weight: bold;">Marque Text</label>
		                           <input type="hidden" name="types[]" value="marquee">
								   <input class="form-control" type="text" name="marquee" placeholder="Marquee Text" value="{{ get_setting('marquee')->value ?? 'Null' }}">
								   @error('marquee')
		                                <p class="text-danger">{{$message}}</p>
		                            @enderror
		                        </div>
				...
				<div class="col-md-5">
				    ...
				    <div class="card d-none">
				        ...
				        <div class="card-body">
				        	<div class="row">
				        		<div class="col-sm-12 mb-3">
                                    <label for="pinterest_url" class="col-form-label" style="font-weight: bold;">Order Return Duration :</label>
