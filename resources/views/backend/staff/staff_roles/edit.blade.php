                ...
                <div class="card">
                    ...
                    <form action="{{ route('roles.update', $role->id) }}" method="POST">
                        ...
                        <div class="card-body">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            <!--New Permission for Product Stock -->
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label">Product Stock
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label" id="flexSwitch2">Update Order Payment
                                                        Status
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                            ...
                            <div class="bd-example">
                                <ul class="list-group">
                                    <li class="list-group-item bg-light" aria-current="true">Generate Invoice</li>
                                    <li class="list-group-item">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label">Invoice Create
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label">Invoice Return
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label">Invoice View
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label">Invoice Delete
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label" id="flexSwitch1">View All Staffs
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                                                value="25" type="checkbox" id="flexSwitch1"
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label" id="flexSwitch2">SMS Templates
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                                                value="34" type="checkbox" id="flexSwitch2"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label" id="flexSwitch2">Sms Providers
                                                        Configurations
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label" id="flexSwitch1">View All Slider
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                                                value="37" type="checkbox" id="flexSwitch1"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label" id="flexSwitch1">View All Campaing
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                                                value="41" type="checkbox" id="flexSwitch1"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label" id="flexSwitch1">View All Supplier
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                                                value="45" type="checkbox" id="flexSwitch1"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label" id="flexSwitch2">Delete Supplier
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                                                value="48" type="checkbox" id="flexSwitch2"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                    <label class="control-label" id="flexSwitch1">View All Page
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="permissions[]"
                                                                value="49" type="checkbox" id="flexSwitch1"
