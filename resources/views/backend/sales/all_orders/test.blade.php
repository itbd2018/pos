...
@push('footer-script')
    ...
    <script type="text/javascript">
       ...
       // Trigger modal and populate fields dynamically
$('#update_payment_status').on('change', function () {
    var status = $('#update_payment_status').val();

    if (status == '1') { // If "Paid" is selected
...
$('#paymentModal').on('input', '#first_installment, #second_installment, #third_installment', function () {
    var productPrice = parseFloat($('#product_price').val()) || 0;
    var paidAmount = parseFloat($('#paid_amount').val()) || 0;

    var firstInstallment = parseFloat($('#first_installment').val()) || 0;
    var secondInstallment = parseFloat($('#second_installment').val()) || 0;
    var thirdInstallment = parseFloat($('#third_installment').val()) || 0;

    var totalPaid = paidAmount + firstInstallment + secondInstallment + thirdInstallment;
    var dueAmount = productPrice - totalPaid;
