            ...
            <div class="row">
                <div class="col-md-8 offset-2">
                    <div class="content-header">
                        <h2 class="content-title">Affiliate Accout Create</h2>
                        <div class="">
                            <a href="{{ route('vendor.index') }}" class="btn btn-primary p-3" title="Affiliate Account List"><i
	                        ...
	                        @endif --}}
                                <form method="post" action="{{ route('vendor.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" id="shop_name" type="text" name="shop_owner_name"
                                            placeholder="Write vendor Owner name" value="{{ old('shop_owner_name') }}">
                                        @error('shop_name')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" id="phone" type="text" name="phone"
                                            placeholder="Write vendor phone number" value="{{ old('phone') }}">
                                        @error('phone')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" id="email" type="email" name="email"
                                            placeholder="Write vendor email address" value="{{ old('email') }}">
                                        @error('email')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" id="address" type="text" name="address"
                                            placeholder="Write vendor address" value="{{ old('address') }}">
                                        @error('address')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    {{-- <div class="mb-4">
                                        <label for="discount_type" class="col-form-label"
                                            style="font-weight: bold;">Comission Type:</label>
                                    ...
                                    {{-- <div class="mb-4">
                                        <label for="commission" class="col-form-label col-md-4"
                                            style="font-weight: bold;">Commission : <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" id="commission" type="text" name="commission"
                                            required placeholder="Write vendor commission" value="{{ old('commission') }}">
                                    </div> --}}

                                    {{-- <div class="mb-4">
                                        <label for="description" class="col-form-label col-md-4"
                                            style="font-weight: bold;">Description :</label>
                                        <textarea name="description" id="description" cols="5" placeholder="Write vendor description"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-4">
                                                <label for="image" class="col-form-label"
                                                    style="font-weight: bold;">Profile Image: <span
                                                        class="text-danger">*</span></label>
                                                <input name="shop_profile" class="form-control" type="file"
                                                    id="image">
                                                @error('shop_profile')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                    ...
                                    {{-- <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input name="trade_license" class="form-control" type="file"
                                                    id="image4">
                                            </div>
                                        </div>
                                    </div> --}}
                        ...
                        <div class="row">
	                        ...
	                        @endif --}}
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="col-form-label col-md-6" style="font-weight: bold;"
