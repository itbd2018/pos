		                ...
		                <div class="col-md-12">
		                    <form method="post" action="{{ route('blog.update',$blog->id) }}" enctype="multipart/form-data">
		                        ...
		                        <div class="mb-4">
								 ...
								 <div class="mb-4">
		                           <label for="title_en" class="col-form-label col-md-2" style="font-weight: bold;"> Description :</label>
		                            <textarea class="form-control summernote" type="text" name="description_en" placeholder="Write blog title english" value="{{old('title_en')}}">{{ $blog->description_en }}</textarea>
		                            @error('title_en')
	                                    <p class="text-danger">{{$message}}</p>
	                                @enderror
		                        </div>
