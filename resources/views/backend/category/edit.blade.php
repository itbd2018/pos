                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="{{ route('category.update', $category->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-md-3 col-form-label">Parent Brand</label>
                                    <div class="col-md-9">
                                ...
                                <div class="mb-4">
                                    <div class="demo-checkbox">
                                        <input type="checkbox" id="md_checkbox_29" class="form-check-input cursor" name="category_tab" {{ $category->category_tab == 1 ? 'checked': '' }} value="1">
                                        <label for="md_checkbox_29" class="form-check-label cursor" style="font-weight: bold; padding-left: 8px;"> Include to Category Tab</label>
                                    </div>
                                </div>
