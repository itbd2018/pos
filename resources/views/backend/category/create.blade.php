                    ...
                    <div class="row">
                        <div class="col-md-12">
                           <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
			                    ...
			                    <div class="form-group row mb-4">
			                    	<label for="parent_id" class="col-md-3 col-form-label" style="font-weight: bold;">Parent Brand:</label>
				                    <div class="col-md-9">
...
{{--                                </div>--}}
                               ...
                               <div class="mb-4">
                                   <div class="demo-checkbox">
                                       <input type="checkbox" id="category_tab" class="form-check-input cursor" name="category_tab" value="1">
                                       <label for="category_tab" class="form-check-label cursor" style="font-weight: bold; padding-left: 8px;"> Include to Category Tab</label>
                                   </div>
                               </div>
