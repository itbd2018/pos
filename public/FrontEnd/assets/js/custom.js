$(function () {
    ...
    $(document).ready(function () {
        function initMobileSlider() {
            if ($(window).width() <= 767) {
                if (!$(".categorytab-slider").hasClass("slick-initialized")) {
                    $(".categorytab-slider").slick({
                        slidesToShow: 3,
                        slidesToScroll: 1,
                        autoplay: false,
                        dots: false,
                    ...
                    $(".categorytab-slider").on(
                        "click",
                        ".slick-slide",
                        function () {
                            var clickedIndex = $(this).data("slick-index");
                            var currentIndex = $(".categorytab-slider").slick(
                                "slickCurrentSlide"
                            );

                            if (clickedIndex > currentIndex) {
                                $(".categorytab-slider").slick("slickNext");
                            } else if (clickedIndex < currentIndex) {
                                $(".categorytab-slider").slick("slickPrev");
                            }
                        }
                    );
                }
                ...
                if ($(".categorytab-slider").hasClass("slick-initialized")) {
                    $(".categorytab-slider").slick("unslick");
                }
            }
        }
